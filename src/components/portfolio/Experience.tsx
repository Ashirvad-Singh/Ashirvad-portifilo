...
export function Experience() {
  ...
  return (
    <section ref={ref} id="experience" className="relative mx-auto max-w-6xl px-6 py-28">
      <p className="mb-4 text-xs font-semibold uppercase tracking-[0.3em] text-primary">Experience</p>
      <h2 className="mb-16 text-4xl font-bold tracking-tight md:text-5xl">Where I've built.</h2>
